 ...
 * Called from the root middleware. Returns the response (with refreshed cookies)
 * plus the resolved user so the middleware can redirect unauthenticated users.
 */
